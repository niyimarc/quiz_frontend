...
ROOT_URLCONF = 'quiz_frontend_project.urls'
...
WSGI_APPLICATION = 'quiz_frontend_project.wsgi.application'
...
PROXY_BASE_URL = os.environ.get("PROXY_BASE_URL", "http://127.0.0.1:8001/proxy/")
